...
from aiogram_dialog.widgets.kbd import Button, Group, ScrollingGroup, \
      Select, Calendar, CalendarConfig, Back, Cancel
from aiogram_dialog.widgets.text import Const, Format
from app.tg_bot.booking.getters import get_all_tables, get_all_available_slots, get_confirmed_data
from app.tg_bot.booking.handlers import (
